...
export default function ClientReviews() {
	...
	return (
		<main className="relative w-screen h-screen text-white overflow-hidden">
			<Back/>
			<div className="overflow-y-scroll h-[92vh] w-screen mt-[8vh]">
				<div className="px-12 text-center bg-gradient-to-r from-gradient to-secondary">
					<Partners />
					<h1 className="font-forum pt-6">A client's reviews page</h1>
					<p className="w-2/3 mx-auto pb-12">
				...
				<section className="relative grid justify-items-center overflow-hidden text-center gap-[10vh] py-[10vh] w-screen min-h-screen bg-contrast">
					...
					<article className="relative w-4/5 md:w-2/3 h-fit rounded-lg drop-shadow-xl overflow-hidden group">
						<div className="relative z-10 w-3/5 h-fit p-4 grid justify-items-center bg-gradient-to-b from-contrast-dark1 to-contrast-dark2" >	
