...
export default function HomeNavbar() {
	return (
		<div className="drop-shadow-2xl">
			<nav className="home-navbar bg-gradient-to-r from-yellow-500 to-amber-600 h-64">
				<div className="home-navbar-shadow">
					<ul className="home-navbar-line bg-gradient-to-l from-yellow-400 to-amber-400 h-48 grid grid-cols-3 text-5xl leading-normal">
